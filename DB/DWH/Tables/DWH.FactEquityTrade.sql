...
GO
ALTER TABLE [DWH].[FactEquityTrade] ADD CONSTRAINT [FK_FactEquityTrade_DimDate1] FOREIGN KEY ([PublishDateID]) REFERENCES [DWH].[DimDate] ([DateID])
GO
...
GO
ALTER TABLE [DWH].[FactEquityTrade] ADD CONSTRAINT [FK_FactEquityTrade_DimInstrumentEquity] FOREIGN KEY ([InstrumentID]) REFERENCES [DWH].[DimInstrumentEquity] ([InstrumentID])
GO
ALTER TABLE [DWH].[FactEquityTrade] ADD CONSTRAINT [FK_FactEquityTrade_DimTime] FOREIGN KEY ([PublishTimeID]) REFERENCES [DWH].[DimTime] ([TimeID])
GO
