...
(
[Mixed] [varchar] (50) COLLATE Latin1_General_CI_AS NULL,
...
[A_TRADE_DATE] [datetime] NULL,
[A_TRADE_TIMESTAMP] [datetime] NULL,
...
[A_MATCH_PRICE_X] [decimal] (28, 0) NULL,
[A_TRADE_SIZE_X] [decimal] (28, 0) NULL,
[A_AUCTION_TRADE_FLAG] [varchar] (2) COLLATE Latin1_General_CI_AS NULL,
[A_MEMBER_ID] [varchar] (50) COLLATE Latin1_General_CI_AS NULL,
[A_ACCOUNT_TYPE] [varchar] (50) COLLATE Latin1_General_CI_AS NULL,
[A_ORDER_TYPE] [varchar] (1) COLLATE Latin1_General_CI_AS NULL,
[A_ORDER_RESTRICTION] [varchar] (1) COLLATE Latin1_General_CI_AS NULL,
[A_ORDER_MARKET_VALUE] [decimal] (28, 0) NULL,
[A_MEMBER_CTPY_ID] [varchar] (50) COLLATE Latin1_General_CI_AS NULL,
[A_SETTLEMENT_DATE] [date] NULL,
[A_SETTLEMENT_TYPE] [varchar] (4) COLLATE Latin1_General_CI_AS NULL,
[A_MOD_REASON_CODE] [varchar] (3) COLLATE Latin1_General_CI_AS NULL,
[A_INSERT_TIMESTAMP] [datetime] NULL,
...
[A_TRADER_ID] [varchar] (50) COLLATE Latin1_General_CI_AS NULL,
[A_BEST_BID_PRICE] [decimal] (28, 0) NULL,
[A_BEST_ASK_PRICE] [decimal] (28, 0) NULL,
[A_OFFICIAL_OPENING_PRICE] [decimal] (28, 0) NULL,
[A_OFFICIAL_CLOSING_PRICE] [decimal] (28, 0) NULL,
