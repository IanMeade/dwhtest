...
GO
ALTER TABLE [dbo].[TxSaft] ADD CONSTRAINT [PK_TxSaft_1] PRIMARY KEY CLUSTERED  ([DwhFileID], [TxSfaftID]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_TxSaft_2] ON [dbo].[TxSaft] ([A_TRADE_DATE], [A_ISIN]) ON [PRIMARY]
GO
