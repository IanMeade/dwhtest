/* SSIS CONFIGURATIONS */
/* CONNECTIONS TO T7-SYS-DW-01 FROM DWH ENVIRONMENT */


EXEC [SSISDB].[catalog].[delete_environment] @environment_name=N'DWH', @folder_name=N'DWH'
...
EXEC [SSISDB].[catalog].[create_environment] @environment_name=N'DWH', @environment_description=N'', @folder_name=N'DWH'
...
DECLARE @var sql_variant = N'Data Source=T7-SYS-DW-01;Initial Catalog=Reuters_ODS;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;'
...
GO
DECLARE @var sql_variant = N'Data Source=T7-SYS-DW-01;Initial Catalog=StateStreet_ODS;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;'
...
GO
DECLARE @var sql_variant = N'Data Source=T7-SYS-DW-01;Initial Catalog=Stoxx_ODS;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;'
